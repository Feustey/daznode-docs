module.exports = {
      ...
      typography: (theme) => ({
        DEFAULT: {
          css: {
            ...
            blockquote: {
              ...
              // Style spécifique pour les listes dans les blockquotes
              ul: {
                marginTop: '1rem',
                marginBottom: '1rem',
                li: {
            ...
            // Style pour les check-lists (listes avec emoji ou symbole check)
            '.checklist': {
              listStyleType: 'none',
              paddingLeft: '1.75rem',
              li: {
        ...
        dark: {
          css: {
            ...
            // Ligne horizontale en mode sombre
            hr: {
              borderColor: theme('colors.gray.700')
            },
  ...
  plugins: [
    ...
    function({ addComponents, theme }) {
      const components = {
        // Amélioration des puces dans la prose
        '.prose-bullets ul li': {
          position: 'relative',
          paddingLeft: '1.5rem',
          '&::before': {
        ...
        // Dark mode - simplified selectors to avoid nested issues
        '.dark .table-enhanced': {
          borderColor: theme('colors.gray.700'),
          boxShadow: '0 2px 6px rgba(0, 0, 0, 0.3)'
        },
